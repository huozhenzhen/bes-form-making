  ...
  <div v-if="show">
    <el-form label-position="top">
      ...
      >
        ...
        <template v-if="data.options.remote">
          <div>
            ...
            <el-input size="mini" style v-model="data.options.remotePath">
              <template slot="prepend">{{ $t('fm.config.widget.remotePath') }}</template>
            </el-input>
      ...
      <el-form-item
        ...
        v-if="Object.keys(data.options).indexOf('defaultValue') >= 0 && (data.type == 'textarea' || data.type == 'input' || data.type == 'rate' || data.type == 'color' || data.type == 'switch' || data.type == 'text')"
      >
        <el-input
